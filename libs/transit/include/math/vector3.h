...
class Vector3 {
   public:
      ...
      /**
       * @brief Overrides - operator.
       * @param[in] v The Vector3 object you would like to subtract to this
       * Vector3 object
       * @return The Vector3 Object comprised of the subtraction of the two
       * objects
       */
      ...
      /**
       * @brief Overrides * operator.
       * @param[in] v The Vector3 object you would like to multiply to this
       * Vector3 object
      ...
      /**
       * @brief Overrides / operator.
       * @param[in] v The Vector3 object you would like to divide to this
       * Vector3 object
